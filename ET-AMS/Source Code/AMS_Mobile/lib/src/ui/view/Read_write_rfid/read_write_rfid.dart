...
import 'package:flutter_application_1/src/controllers/rfid_write_controller.dart';
...
class _RadWriteRfidState extends State<RadWriteRfid> {
  final RfidWriteController controller = Get.put(RfidWriteController());
  ...
  Widget build(BuildContext context) {
    ...
    Future.delayed(Duration.zero, () {
      ...
      tooltipController.showTooltip('Using this screen we can read and write in and RFID tag.');
