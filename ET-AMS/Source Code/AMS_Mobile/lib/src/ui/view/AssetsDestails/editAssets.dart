...
late TextEditingController updatedDescription;
 late TextEditingController updatedStatus;
...
var arg=Get.arguments;
  ...
  void initState() {
    ...
    super.initState();
    updatedLocation=TextEditingController(text: arg['locationDescription']!=null? arg['locationDescription']:"");
    updatedDescription=TextEditingController(text: arg['assetDescription']!=null?arg['assetDescription']:"");
  }


  @override
  Widget build(BuildContext context) {
    log(arg['locationDescription']);
    return Scaffold(
        ...
        children: [
          SingleChildScrollView(
            child: Padding(
              ...
              child: Column(
                children:  [
                  TextFormFildWidgets(
                    title: 'Asset Tag ID:*', icon: Icons.qr_code_scanner,onPressd: (){
                  ...
                  txtcontroller: updatedDescription,),
                  SizedBox(height: 20,),
          ...
          Padding(
            ...
            child: Align(alignment: Alignment.bottomCenter,
              child: CommonBtn(title: 'Update',onPressd: (){
                fetchData();
...
fetchData() async {
  ...
  var request = http.Request('POST' ,Uri.parse('http://192.168.1.7:9009/api/Location/UpdateAssetStatusAndLocation?assetTagId=TAG011&statusID=1&locationID=1'));
