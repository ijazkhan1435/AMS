...
import 'package:flutter_application_1/src/controllers/bluetooth_controller.dart';
...
class _BluetoothScreenState extends State<BluetoothScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    Future.delayed(Duration.zero, () {
      ...
      tooltipController.showTooltip('This is used to pair RFID reader with the device/mobile.');
